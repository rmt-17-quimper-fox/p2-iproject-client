            ...
            <div class="col-md-8">
                <div class="feed p-2">
                    ...
                    <div class="bg-white border mt-2"
                        ...
                        :key="tweet.id">
                        <div>
                            <div class="justify-content-between align-items-center p-2 border-bottom">
                                <div class="align-items-center feed-text px-2"><img class="rounded-circle" src="https://i.imgur.com/aoKusnD.jpg" width="45">
